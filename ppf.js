...
function ppf_calc_func(){
	...
	//to link an form control to javascript use getelementbyid

    var amount = document.getElementById('x1').value; //to select from id geteelement by id 
    ...
    if(amount == '' || roi =='' || duration ==''){
        ...
        amount = +amount; //in jvascript it treats everything as an string to convert into numeric data type +is used.
        roi = +roi;
